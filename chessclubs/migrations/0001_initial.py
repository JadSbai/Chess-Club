# Generated by Django 3.2.5 on 2021-12-12 00:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SmallPoolPhase',
            fields=[
                ('poolphase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='chessclubs.poolphase')),
            ],
            bases=('chessclubs.poolphase',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='tournament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pool_phases', to='chessclubs.tournament'),
        ),
        migrations.CreateModel(
            name='Pool',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_elimination_round', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='EL_players', to='chessclubs.eliminationrounds')),
                ...
                ('tournament', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='players', to='chessclubs.tournament')),
