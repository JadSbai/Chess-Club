...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chessclubs', '0006_merge_20211206_1534'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='capacity',
            field=models.IntegerField(default=2, validators=[django.core.validators.MaxValueValidator(96), django.core.validators.MinValueValidator(2, 'The capacity needs to be at least 2.')]),
        ),
    ]
